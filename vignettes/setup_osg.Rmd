---
title: "Set-up OSG to work with ssgrid"
author: "Nicholas Ducharme-Barth"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Set-up OSG to work with ssgrid}
...
**Step 2.5**: Once inside R, check to see if the directory that you created in step 1, *R-packages*, is in the library path.
```{r}
...
**Step 2.7**: Exit the R environment that you entered into in step 3.
